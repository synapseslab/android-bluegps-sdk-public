...
- [3. Usage guide](#3-usage-guide)
    ...
    - [3.2 App Authetication](#32-app-authetication)
    - [3.3 Authentication status](#33-authentication-status)
    - [3.4 Guest login](#34-guest-login)
    - [3.5 Logout](#35-logout)
- [4. Use BlueGPS Advertising Service](#4-use-bluegps-advertising-service)
    - [4.1. Get device configuration](#41-get-device-configuration)
    - [4.2. Optional](#42-optional)
- [5 BlueGPSMapView](#5-bluegpsmapview)
    - [5.1 Map Listener](#51-map-listener)
    - [5.2 Map Interactions](#52-map-interactions)
      - [5.2.1 resetView](#521-resetview)
      - [5.2.2 rotate](#522-rotate)
      - [5.2.3 rotateAbsolute](#523-rotateabsolute)
      - [5.2.4 hideRoomLayer](#524-hideroomlayer)
      - [5.2.5 nextFloor](#525-nextfloor)
      - [5.2.6 showTag](#526-showtag)
      - [5.2.7 getFloor](#527-getfloor)
      - [5.2.8 gotoFloor](#528-gotofloor)
      - [5.2.9 gotoFromMe](#529-gotofromme)
      - [5.2.10 goto](#5210-goto)
      - [5.2.11 getMapStyle](#5211-getmapstyle)
      - [5.2.12 setMapStyle](#5212-setmapstyle)
      - [5.2.13 setStartBookingDate](#5213-setstartbookingdate)
      - [5.2.14 setBookingDate](#5214-setbookingdate)
      - [5.2.15 reloadResource](#5215-reloadresource)
      - [5.2.16 removeNavigation](#5216-removenavigation)
      - [5.2.17 loadGenericResource](#5217-loadgenericresource)
      - [5.2.18 selectPoi](#5218-selectpoi)
      - [5.2.19 selectPoiById](#5219-selectpoibyid)
      - [5.2.20 drawPin](#5220-drawpin)
      - [5.2.21 getCurrentFloor](#5221-getcurrentfloor)
      - [5.2.22 centerToRoom](#5222-centertoroom)
      - [5.2.23 centerToPosition](#5223-centertoposition)
      - [5.2.24 initAllBookingLayerBy](#5224-initallbookinglayerby)
      - [5.2.25 setDarkMode](#5225-setdarkmode)
      - [5.2.26 showResourceOnMap](#5226-showresourceonmap)
      - [5.2.27 clearSelection](#5227-clearselection)
      - [5.2.28 activatePositionMarker](#5228-activatepositionmarker)
      - [5.2.29 clearPositionMarker](#5229-clearpositionmarker) 
      - [5.2.30 getPositionMarker](#5230-getpositionmarker)    
